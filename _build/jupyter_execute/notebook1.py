...
fig1, solved_models = plot_impulse([np.float(r) for r in rhos.value.split(',')],                              timeHorizon.value, phi1.value,                              phi2.value, alpha_k.value, productivity.value, delta.value, A, B,                              U_k, σ_k, U_d, σ_d, int(order.value), γ, slider_object.value, habit.value, χ, α, ϵ, 
